    ...
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Generate SQL scripts from your database design for different SQL
          dialects.
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          {!hasDesignData && (
            <p className="text-sm text-muted-foreground">
              No tables found in your design. Please add tables in the Workbench
              or Tables section first.
            </p>
          )}
        </CardContent>
      </Card>
