...
import { DeleteConfirmationDialog, type DeleteConfirmationDialogProps } from './delete-dialog.tsx'
...
test('should render correctly ', () => {
  const { getByText, getByRole } = render(<DeleteConfirmationDialog {...mockProps} />)
