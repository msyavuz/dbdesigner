...
export function edgesToDesign(edges: Edge[], prevRelationships: ForeignKey[]): ForeignKey[] {
...
export const isDesignChanged = (initialDesign: Design, currentDesign: Design): boolean => {
  ...
  return (
    ...
    JSON.stringify(initialDesign.relationships) !== JSON.stringify(currentDesign.relationships)
  )
}
